...
| <code><a href="#deploy-time-build.NodejsBuildProps.property.nodeJsVersion">nodeJsVersion</a></code> | <code>number</code> | The version of Node.js to use in a build environment. |
...
The version of Node.js to use in a build environment.
